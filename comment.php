...
<table width="1000" border="0" align="center" background="Diagrams/plasma-turbulence-web-background.jpg">
  <tr>
    ...
    <form action="<?php print $_SERVER["PHP_SELF"]; ?>" method="GET">
	  ...
	  <p>
	    <input name="submit" type="submit" value="View comment"/>
...
if(isset($_GET["submit"])){
	...
	if($num_rows>0){
		if($num_rows>1)
		   ...
		   ?>
			...
			<tr>
			  ...
			  <td class="style4">(<?php echo strtoupper($row2[department]); echo" department"; ?>)<?php echo ucwords($row2[designation]); ?></td>
			</tr>
			<tr>
			  <td>&nbsp;</td>
			  <td class="style2"> <em><?php echo $row1[comment]; ?></a></em></td>
			</tr>
			</table>
		  <p>
			<?php
		...
		<marquee>
			<?php	
			echo "<font color=\"red\" face='georgia'><i>No comments in $month $year</i></font>";
			?>
		</marquee>
		<?php
	}
