...
function tc_setDay(objname, dvalue){
	...
	if(!isDateAllow(objname, dvalue, date_array[1], date_array[0])){
		...
		if(isDate(dvalue, date_array[1], date_array[0])){			
			...
			obj.src = path+"calendar_form.php?objname="+objname.toString()+"&selected_day="+dvalue+"&selected_month="+date_array[1]+"&selected_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar+"&inp="+inp+"&fmt="+fmt+"&dis="+dis+"&pr1="+pr1+"&pr2="+pr2+"&prv="+prv;
...
function tc_setMonth(objname, mvalue){
	...
	if(!isDateAllow(objname, date_array[2], mvalue, date_array[0])){
		...
		if(isDate(date_array[2], mvalue, date_array[0])){
			...
			obj.src = path+"calendar_form.php?objname="+objname.toString()+"&selected_day="+date_array[2]+"&selected_month="+mvalue+"&selected_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar+"&inp="+inp+"&fmt="+fmt+"&dis="+dis+"&pr1="+pr1+"&pr2="+pr2+"&prv="+prv;
...
function tc_setYear(objname, yvalue){
	...
	if(!isDateAllow(objname, date_array[2], date_array[1], yvalue)){
		...
		if(isDate(date_array[2], date_array[1], yvalue)){
			...
			obj.src = path+"calendar_form.php?objname="+objname.toString()+"&selected_day="+date_array[2]+"&selected_month="+date_array[1]+"&selected_year="+yvalue+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar+"&inp="+inp+"&fmt="+fmt+"&dis="+dis+"&pr1="+pr1+"&pr2="+pr2+"&prv="+prv;
...
function checkPairValue(objname, d){
	...
	if(dp1 != "" && document.getElementById(dp1) != null){ //imply to date_pair1
		...
		obj.src = path+"calendar_form.php?objname="+dp1+"&selected_day="+date_array[2]+"&selected_month="+date_array[1]+"&selected_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar+"&inp="+inp+"&fmt="+fmt+"&dis="+dis+"&pr1="+pr1+"&pr2="+pr2+"&prv="+prv;
	...
	if(dp2 != "" && document.getElementById(dp2) != null){ //imply to date_pair2
		...
		obj.src = path+"calendar_form.php?objname="+dp2+"&selected_day="+date_array[2]+"&selected_month="+date_array[1]+"&selected_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp+"&mon="+smon+"&da1="+da1+"&da2="+da2+"&sna="+sna+"&aut="+aut+"&frm="+frm+"&tar="+tar+"&inp="+inp+"&fmt="+fmt+"&dis="+dis+"&pr1="+pr1+"&pr2="+pr2+"&prv="+prv;
